...
class Mission extends React.Component {
  ...
  render() {
    ...
    const sectionHeader = {
      title: <span>We’re an investment firm that is driven by purpose, a clear <span style={{ fontWeight: 800, fontStyle: 'italic' }}>mission</span>, and an important set of core values</span>,
